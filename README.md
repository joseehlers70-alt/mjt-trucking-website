...
`SUPABASE_SERVICE_ROLE_KEY` must remain server-side and is never read by the browser application.
...
mark status, upload photos, select the lead photo, and delete inventory.
